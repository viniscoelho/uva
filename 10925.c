/*
	Solucao:
		Uso de estrutura bignum. MAXDIGITS define o tamanho que o numero pode ter
		Contem funcoes de soma, subtracao, multiplicao e divisao.
		Soma a conta do bar e divide entre o numero de amigos
*/
